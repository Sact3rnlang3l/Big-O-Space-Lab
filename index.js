...
// ANSWER:
// not much without setting a specific limit
// function getNumbersSquared(numbers) {
//   let answers = []

//   for (let i = 0; i < numbers.length; i++) {
//     let squared = Math.pow(numbers[i], 2)
//     answers.push(squared)
//   }
//   return answers
// }
...
// ANSWER:
// The first function is defined be the input, and only the input.
// the second function loops over the array length, which can change, instead of being predefined by the string.
...
console.log(no_cache_calc_fac(8))
console.log(no_cache_calc_fac(8))
console.log(no_cache_calc_fac(8))
console.log(no_cache_calc_fac(8))
...
console.log(Factorial.calc_fac(8))
console.log(Factorial.calc_fac(8))
console.log(Factorial.calc_fac(8))
console.log(Factorial.calc_fac(8))
